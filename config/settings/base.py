...
APPS_DIR = ROOT_DIR.path('wishlist')
...
# ------------------------------------------------------------------------------
MIGRATION_MODULES = {
    'sites': 'wishlist.contrib.sites.migrations'
}
...
ADMINS = [
    ("""Kacper Wierzbicki""", 'yavinlecretin@gmail.com'),
]
...
ACCOUNT_ADAPTER = 'wishlist.users.adapters.AccountAdapter'
SOCIALACCOUNT_ADAPTER = 'wishlist.users.adapters.SocialAccountAdapter'
